...
安裝您平台適用的最新可用版本。 務必升級 Dispatcher 執行個體來使用最新版，以充分利用產品和安全性增強功能。 請參閱[安裝 Dispatcher](dispatcher-install.md)。

>[!NOTE]
>
>查看 Dispatcher 記錄檔來檢查 Dispatcher 安裝的現有版本。
>
...
在 Dispatcher 層級，有[兩個設定方法可避免 DoS 攻擊](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/configure-aem-dispatcher-to-prevent-dos-attacks-aem-community/m-p/447780)。
...
AEM 提供了旨在避免跨網站請求偽造攻擊的[架構](https://experienceleague.adobe.com/en/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions#verification-steps)。 為了正確地使用此框架，您在 Dispatcher 中必須允許加入 CSRF 權杖支援的清單。
