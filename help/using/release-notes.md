...
* DISP-693 - 在 Dispatcher 下載頁面上更新 Solaris™ 伺服器的架構詳細資料
* DISP-695 - Dispatcher 模組 4.2.3 中的 DispatcherLog 層級發生問題
* DISP-698 - Dispatcher TTL 必須支援 s-maxage 和 private 指示詞
* DISP-700 - 模組無法在 Alpine Linux® 上正常運作
* DISP-704 - 包含 %2b 的瀏覽器請求以未編碼形式傳送給發佈者
* DISP-705 - 由於重複釋放或損毀 (fasttop) 導致 Dispatcher 當機 (`fasttop`)
