...
若要了解更多關於要求和先決條件，請參閱「[支援平台](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/implementing/deploying/introduction/technical-requirements#dispatcher-platforms-web-servers)」。
